    ...
    <div style={s.page}>
      ...
      <main style={s.main}>
        ...
        <div style={s.header}>
          ...
          <div>
            <h1 style={s.pageTitle}>إضافة موظف جديد</h1>
            <p style={s.pageSub}>أدخل بيانات الموظف الجديد</p>
          </div>
        </div>
        ...
        <div style={s.layout}>
          ...
          <div style={s.sideCard}>
            ...
            <p style={s.sideSub}>اختياري — JPG أو PNG بحد أقصى 2MB</p>
            ...
            <label className="upload-zone" style={s.uploadZone}>
              {preview ? (
                ...
                <div style={s.uploadPlaceholder}>
                  ...
                  <p style={s.uploadHint}>أو اسحب وأفلت هنا</p>
                </div>
              )}
              <input
                type="file"
